...
bool D3DWindow::Create() { return true; }

bool D3DWindow::Create(int width, int height, int bpp, bool fullscreen, const std::string& title, int fsaa, int openglMajor, int openglMinor) { return true; }
...
bool D3DWindow::LoadXMLSettings(pugi::xml_node& windowNode) { return true; }

bool D3DWindow::IsRunning() { return isRunning; }
...
bool D3DWindow::GetVSync() { return true; }
